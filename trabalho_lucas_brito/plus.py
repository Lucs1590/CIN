...
class GeneticAlgorithm(object):
    ...
    def run_genetic_algorithm(self, goal):
        ...
        while True or (i == 2000000):
            ...
            if goal == population:
                ...
                aptitudes = self.aux.calculate_aptitude(hamming_distance, 10)
    ...
    def generate_population(self, indiv_number, _seed=time()):
        ...
        for individual in range(indiv_number):
            population.append(self.aux.to_bin(randint(0, 255)))
...
class AuxClass(object):
    ...
    def calculate_hamming(self, population, goal):
        ...
        while i < len(population):
            hamming_distance.append(self.hamming(goal[i], population[i]))
            i += 1
    ...
    def to_bin_array(self, some_array):
        ...
        while i < len(some_array):
            bits_array = []
            i_2 = 2
            while i_2 < len(some_array[i]):
                bits_array.append(int(some_array[i][i_2]))
                i_2 += 1
            final_array.append(bits_array)
            i += 1
...
def main():
    ...
    start_time = time()
    results = genetic.run_genetic_algorithm([
        '0b01010101',
        '0b10101010',
        '0b01010101',
        '0b10101010',
